...
def demo(photo_count, countdown_from):
    ...
    GPIO.add_event_detect(channel, GPIO.FALLING)  # add falling edge detection on a channel
...
if __name__ == "__main__":
    ...
    parser.add_argument('--photo-count', type=int, default=4, help='How many photos to take')
